...
export default function Topbar({ activeSection, onNavigate }) {
  ...
  return (
    <>
      {/* Mobile topbar (Hidden on desktop because Sidebar handles navigation) */}
      <header className="lg:hidden sticky top-0 z-40 bg-panel/90 backdrop-blur-sm border-b border-border">
        {/* Identity bar */}
        <div className="flex items-center justify-between px-4 lg:px-6 h-12 border-b border-border/60">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-muted hover:text-primary hover:bg-[#F1F5F9] transition-colors"
